...
RawFileHeader raw_file_header_create( FileHeader file_header ) {
	...
	raw_file_header.permissions[ 0 ] = file_header.permissions;
	raw_file_header.permissions[ 1 ] = file_header.permissions >> 8;
...
FileHeader file_header_create( RawFileHeader raw_file_header ) {
	...
	file_header.permissions = raw_file_header.permissions[ 0 ] | ( uint_fast16_t ) raw_file_header.permissions[ 1 ] << 8;
